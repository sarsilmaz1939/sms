...
▀███████████     ███     ▀▀███▀▀▀     ▀███████████ 
  ...
  ███    █▀     ▄████▀     ██████████  ▄████████▀  
    ...
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "NUMARA GİR SİKİK): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "ENTER DE GEÇ AMK): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + f"KAÇ TANE SMS SONSUZ İSE ENTER: "+ Fore.LIGHTGREEN_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "KAÇ SANİYE: "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Hatalı giriş yaptın. Tekrar deneyiniz.") 
